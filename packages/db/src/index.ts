...
export type { Account, Product, ProductAccess, Event } from "@kebrane/prisma-client";
export { Role, ProductStatus, AccessStatus, EventSeverity, Prisma } from "@kebrane/prisma-client";
