  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden flex flex-col justify-center items-center gap-[5px] w-11 h-11 rounded-xl hover:bg-secondary active:bg-secondary/80 transition-colors shrink-0"
        onClick={() => setOpen((v) => !v)}
      >
        <span
        ...
        createPortal(
          <>
            ...
            <nav
              ...
              className="fixed top-0 right-0 z-50 h-full w-72 max-w-[85vw] bg-background border-l shadow-2xl flex flex-col lg:hidden"
            >
              {/* En-tête du drawer */}
              ...
              {/* Mêmes sections que la barre latérale : sous `lg`, le menu doit
                  montrer la MÊME application, pas une version appauvrie. Il
                  listait cinq entrées à plat là où la barre en groupe huit. */}
